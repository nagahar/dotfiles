...
"     ｰ If the retrieve was not successful, or
"     ｰ if handler already cared for displaying the file (e.g. URL
...
"
"     Details :
"     ｰ File name should be a pathname to (an existing) local file or directory.
"       Note : the 
"     ｰ File name's path separator should be slash (not backslash).
"     ｰ It does not hurt if file is already displayed (an example for this is
"       vimhelp scheme).
"
