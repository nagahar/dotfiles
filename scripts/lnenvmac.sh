...
ln -s ~/Dropbox/Documents/env/.zshrc.mac ~/.zshrc.mac.sh
...
ln -s ~/Dropbox/Documents/env/.gitignore ~/.gitignore
ln -s ~/Dropbox/Documents/env/.tmux.conf ~/.tmux.conf
ln -s ~/Dropbox/Documents/env/.tmuxinator ~/.tmuxinator
ln -s ~/Dropbox/Documents/env/.xvimrc ~/.xvimrc
ln -s ~/Dropbox/Documents/env/.vimpressrc ~/.vimpressrc
#ln -s ~/Dropbox/Documents/env/.crontab ~/.crontab
